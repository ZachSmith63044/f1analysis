...
class LoadMinSpeed extends StatefulWidget {
  const LoadMinSpeed({super.key});

  @override
  State<LoadMinSpeed> createState() => _LoadMinSpeedState();
}

class _LoadMinSpeedState extends State<LoadMinSpeed> {
  Future<void> loadData(String year, String round, String session) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/minspeed', // Specify the route name
      arguments: jsonMap
    );
  }
