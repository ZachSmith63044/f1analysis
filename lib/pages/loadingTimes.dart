...
class LoadTimes extends StatefulWidget {
  const LoadTimes({super.key});

  @override
  State<LoadTimes> createState() => _LoadTimesState();
}

class _LoadTimesState extends State<LoadTimes> {
  Future<void> loadData(String year, String round, String session) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/timesview', // Specify the route name
      arguments: jsonMap
    );
  }
