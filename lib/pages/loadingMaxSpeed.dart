...
class LoadMaxSpeed extends StatefulWidget {
  const LoadMaxSpeed({super.key});

  @override
  State<LoadMaxSpeed> createState() => _LoadMaxSpeedState();
}

class _LoadMaxSpeedState extends State<LoadMaxSpeed> {
  Future<void> loadData(String year, String round, String session, bool testing) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/maxspeed', // Specify the route name
      arguments: jsonMap
    );
  }
