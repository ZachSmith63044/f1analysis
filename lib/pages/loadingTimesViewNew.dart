...
class LoadTimesNew extends StatefulWidget {
  const LoadTimesNew({super.key});

  @override
  State<LoadTimesNew> createState() => _LoadTimesNewState();
}

class _LoadTimesNewState extends State<LoadTimesNew> {
