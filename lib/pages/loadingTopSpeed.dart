...
class LoadTopSpeed extends StatefulWidget {
  const LoadTopSpeed({super.key});

  @override
  State<LoadTopSpeed> createState() => _LoadTopSpeedState();
}

class _LoadTopSpeedState extends State<LoadTopSpeed> {
  Future<void> loadData(String year, String round, String session) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/topspeed', // Specify the route name
      arguments: jsonMap
    );
  }
