...
class LoadMinimumSpeed extends StatefulWidget {
  const LoadMinimumSpeed({super.key});

  @override
  State<LoadMinimumSpeed> createState() => _LoadMinimumSpeedState();
}

class _LoadMinimumSpeedState extends State<LoadMinimumSpeed> {
  Future<void> loadData(String year, String round, String session, bool testing) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/minimumspeed', // Specify the route name
      arguments: jsonMap
    );
  }
