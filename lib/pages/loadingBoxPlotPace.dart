...
class LoadBoxPlot extends StatefulWidget {
  const LoadBoxPlot({super.key});

  @override
  State<LoadBoxPlot> createState() => _LoadBoxPlotState();
}

class _LoadBoxPlotState extends State<LoadBoxPlot> {
  Future<void> loadData(String year, String round, String session) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/boxplot', // Specify the route name
      arguments: jsonMap
    );
  }
