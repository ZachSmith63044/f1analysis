...
class LoadRaceStart extends StatefulWidget {
  const LoadRaceStart({super.key});

  @override
  State<LoadRaceStart> createState() => _LoadRaceStartState();
}

class _LoadRaceStartState extends State<LoadRaceStart> {
  Future<void> loadData(String year, String round, String session) async
  {
    ...
    Navigator.pushNamed(
      context,
      '/racestart', // Specify the route name
      arguments: jsonMap
    );
  }
